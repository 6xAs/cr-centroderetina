...
<section class="laboratory">
  ...
  <div class="technologies">
    <div class="container">
      <h3 class="last-updated">Buraco Macular</h3>

        <h3>Definição</h3>
        <p>
          É uma doença não muito rara, que afeta mais mulheres que homens,
          a partir dos 40 anos de idade. Ocorre a formação de um pertuíto no centro da mácula,
           causado por uma anomalia da aderência vítreo-retiniana. Os pacientes não tratados perdem
           a visão central e a capacidade de ler, mas mantêm a visão periférica.
        </p><br>
        ...
        <br>
          <h3>Tratamento:</h3>
        <p>
            Cirurgia – Vitrectomia Posterior com colocação de gás. Todos os pacientes evoluem para catarata após
            a cirurgia de buraco de mácula, por isso, em nosso Serviço, optamos por realizar ambas cirurgias no mesmo ato.
        </p>
