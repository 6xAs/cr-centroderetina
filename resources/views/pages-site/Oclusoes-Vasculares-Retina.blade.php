...
@section('title', 'Oclusões Vasculares da Retina')
...
<section class="laboratory">
  ...
  <div class="technologies">
    <div class="container">
      <h3 class="last-updated">Oclusão de veia central da retina</h3>

        <h3>Definição</h3>
        <p>
          Ocorre em pessoas com problemas da coagulação, glaucoma, diabetes mellitus, sendo mais comum entre os pacientes
          hipertensos. Ela pode afetar a visão de três formas: edema de mácula, isquemia macular e glaucoma secundário
          (neovascular). Na sua forma isquêmica, a oclusão da veia comumente leva a cegueira e por isso, deve ser tratada precocemente.
        </p><br>
        ...
        <br>
        <h3 class="last-updated">Oclusão de Ramo venoso </h3><br>

        <h3>Definição:</h3>
        <p>
           Ocorre em pessoas com problemas da coagulação, glaucoma, diabetes mellitus,
          sendo mais comum entre os pacientes hipertensos. Ela pode afetar a visão de três formas:
          edema de mácula, isquemia macular e descolamento de retina. Na sua forma isquêmica, o prognóstico o risco de cegueira é maior.
        </p>
        <br>
        <h3>Diagnóstico: </h3><br>
        <p>
          Exame oftalmológico completo, Retinografia, Angiografia, e OCT (Tomografia de Coerência Óptica) .
        </p>
        <br>
        <h3>Tratamento: </h3><br>
        <p>
  ...
  <h3 class="title text-center">Imagens</h3>
    <section class="grid-wrap">
      <ul class="grid">
        ...
        <li>
          <figure>
            <img src="images/oclusao.jpg" alt="img01"/>
          </figure>
        </li>
    ...
    <section class="slideshow">
      <ul>
        ...
        <li>
          <figure>
            <figcaption>
              <h3>Oclusão de Ramo Venoso</h3>
              <p></p>
            </figcaption>
            <img src="images/oclusao.jpg" alt="img06"/>
          </figure>
        </li>
        <li>
          <figure>
