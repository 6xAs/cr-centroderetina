...
<section class="laboratory">
  ...
  <div class="technologies">
    <div class="container">
      <h3 class="last-updated">Capsulotomia:</h3>

        <p>
          Tratamento a laser utilizado para romper a cápsula posterior do cristalino, quando opacificada após cirurgia de catarata, ou seja,
          facilita a entrada de luz no olho, o que melhora significativamente a visão.
      </p><br>

      <h3>Iridotomia:</h3><br>

        <p>
          Nesta modalidade de tratamento o laser é aplicado na íris, abrindo um pertuito, o que permite a passagem do humor
          aquoso para a parte anterior do olho, ou seja, é indicado nos casos de glaucoma onde este líquido está sendo impedido de percorrer seu caminho natural.
        </p>
        <br>
  ...
  <h3 class="title text-center">Fotos</h3>
    <section class="grid-wrap">
      <ul class="grid">
        ...
        <li>
          <figure>
            <img src="images/yag-laser.jpg" alt="img01"/>
          </figure>
        </li>
      ...
      <ul>
        ...
        <li>
          <figure>
            ...
            <img src="images/yag-laser.jpg" alt="img06"/>
          </figure>
        </li>
        <li>
          <figure>
